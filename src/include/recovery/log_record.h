...
namespace tetodb {
    ...
    public:
        ...
        static uint32_t CalculateSize(LogRecordType type, const Tuple& old_tuple, const Tuple& new_tuple);
    ...
    private:
        ...
        lsn_t prev_lsn_{ INVALID_LSN };    // The previous LSN for this specific transaction (Linked List!)
