...
namespace tetodb {
	...
	public:
		...
		Page(Page&& other) noexcept
			: page_id_(other.page_id_), pin_count_(other.pin_count_), is_dirty_(other.is_dirty_), data_(other.data_) 
		{
	...
	protected:
		...
		// actual data address
		char* data_{ nullptr }; // use raw pointer here because memory is allocated in buffer
