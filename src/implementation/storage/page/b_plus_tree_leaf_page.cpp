...
namespace tetodb {
    ...
    INDEX_TEMPLATE_ARGUMENTS
        uint32_t B_PLUS_TREE_LEAF_PAGE_TYPE::KeyIndex(const KeyType& key, const KeyComparator& comparator) const {
        uint32_t left = 0;
    ...
    INDEX_TEMPLATE_ARGUMENTS
        ...
        std::move_backward(array_ + idx, array_ + current_size, array_ + current_size + 1);
    ...
    INDEX_TEMPLATE_ARGUMENTS
        uint32_t B_PLUS_TREE_LEAF_PAGE_TYPE::Remove(const KeyType& key, const ValueType& value, const KeyComparator& comparator) {
