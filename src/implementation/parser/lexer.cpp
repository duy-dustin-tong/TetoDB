...
const std::unordered_set<std::string> Lexer::keywords_ = {
    ...
    "BIGINT",     "SMALLINT",   "TINYINT", "CHAR",      "JOIN",
    "ON",         "AND",        "OR",      "GROUP",     "BY",
    "SUM",        "COUNT",      "AVG",     "LIMIT",     "OFFSET",
    ...
    "HAVING",     "AVERAGE",    "MED",     "MEDIAN",    "BETWEEN",
    "IN",         "UPPER",      "LOWER",   "LENGTH",    "CONCAT",
    "SUBSTRING",  "DISTINCT",   "UNION",   "INTERSECT", "EXCEPT",
    "WITH",       "VIEW"};
